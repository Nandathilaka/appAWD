...
router.get('/adminViewCs1', function (req, res) {
	const query = {year: n };
	Cs1.find(query,function(err, repeatStuCs1) {
		res.json(repeatStuCs1);
	});
});

router.get('/adminViewCs2', function (req, res) {
	const query = {year: n };
	Cs2.find(query,function(err, repeatStuCs2) {
		res.json(repeatStuCs2);
	});
});

router.get('/adminViewIs1', function (req, res) {
	const query = {year: n };
	Is1.find(query,function(err, repeatStuIsFirst) {
		res.json(repeatStuIsFirst);
	});
	//console.log(repeatStuIsFirst);
	
});

router.get('/adminViewIs2', function (req, res) {
	const query = {year: n };
	Is2.find(query,function(err, repeatStuIsSecond) {
		res.json(repeatStuIsSecond);
	});
	//console.log(repeatStuIsFirst);
